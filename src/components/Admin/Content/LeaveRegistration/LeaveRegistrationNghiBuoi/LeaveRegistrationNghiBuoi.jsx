...
const LeaveRegistrationNghiBuoi = () => {
    ...
    const fetchListLeaveRegistration = async (searchTerm = "", pendingApproval, pageIndex, pageSize) => {
        try {
            let res = await getAllLeaveRegistrationHalfDayOff(searchTerm, pendingApproval, pageIndex, pageSize);
    ...
    return (
        <div className="leaveRegistration-content container">
            <div className="table-leaveRegistration-container">
                ...
                <ListLeaveRegistrationNghiBuoi listLeaveRegistration={listLeaveRegistration} />
