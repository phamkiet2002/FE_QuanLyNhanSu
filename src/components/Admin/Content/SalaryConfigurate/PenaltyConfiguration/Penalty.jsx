...
const Penalty = () => {
  ...
  const fetchListPenalty = async (selectedTypeOfPenalty = null, selectedWorkPlace, pageIndex, pageSize) => {
    try {
      let res = await getAllPenalty(selectedTypeOfPenalty, selectedWorkPlace, pageIndex, pageSize);
  ...
  useEffect(() => {
    fetchListPenalty(selectedTypeOfPenalty, selectedWorkPlace, pageIndex, pageSize);
    fetchWorkPlace();
