      ...
      <Modal.Body>
        <form className="row g-3">
          ...
          <div className="col-md-6">
            ...
            <DatePicker
              selected={dateOfBirth ? new Date(dateOfBirth) : null} // Thay vì new Date()
              onChange={(date) =>
          ...
          <div className="col-md-6">
            ...
            <DatePicker
              selected={joinDate ? new Date(joinDate) : null}
              onChange={(date) => setJoinDate(date ? date.toISOString() : null)}
              dateFormat="dd-MM-yyyy"
              className="form-control"
              placeholderText="Chọn ngày"
              wrapperClassName="w-100"
